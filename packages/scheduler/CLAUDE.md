...
- `metadata.onInitMethods: ['start']` -- starts all jobs after the container is fully initialized
- `metadata.onDestroyMethods: ['stop']` -- stops all jobs, clears timers, and awaits in-flight executions on shutdown
