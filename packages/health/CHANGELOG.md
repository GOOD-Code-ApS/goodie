...
- eb93812: Add `@goodie-ts/management` package with `/health`, `/info`, and `/beans` management endpoints. Health controller is now a library bean in the health package.
