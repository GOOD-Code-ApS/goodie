...
No plugin configuration needed — `@goodie-ts/cache` ships pre-scanned components and AOP config in `components.json`. The transformer auto-discovers them at build time.
