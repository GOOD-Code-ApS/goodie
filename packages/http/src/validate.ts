 ...
 * detects `@Validate` via AST scanning and emits validation middleware
 * before the route handler. The decorator itself is a no-op at runtime —
 * all wiring happens in generated code.
 *
...
export function Validate(
  ...
  // and generates validation middleware in the codegen output.
  return () => {};
}
