...
export function generateCode(
  ...
  lines.push(
    `// AppContext.generated.ts — DO NOT EDIT (generated by @goodie/transformer${versionTag} at ${timestamp})`,
  );
  lines.push("import { ApplicationContext, Goodie } from '@goodie/core'");
  lines.push("import type { BeanDefinition, Dependency } from '@goodie/core'");
  ...
  if (injectionTokens.length > 0) {
    lines.push("import { InjectionToken } from '@goodie/core'");
  }
